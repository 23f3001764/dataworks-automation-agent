...
function_definitions_llm = [
    ...
    {
        "name": "A8",
        "description": "Extract a credit card number from an image and save it to a text file.",
        "parameters": {
            "type": "object",
            "properties": {
                "filename": {
    ...
    {
        "name": "B8",
        "description": "Transcribe an audio file and save the transcript.",
        "parameters": {
            "type": "object",
            "properties": {
                "audio_path": {
    ...
    {
        "name": "B10",
        "description": "Filter a CSV file based on a column and value, returning JSON data.",
        "parameters": {
            "type": "object",
            "properties": {
                "csv_path": {
